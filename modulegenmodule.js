...
(function() {
  var CoffeeGenTask, PugGenTask, StyleGenTask, Task, fs, generateModuleDirectory, generateTasks, getPugName, hooker, log, modulegenmodule, mustache, pathHandler, pathModule;
  ...
  CoffeeGenTask = (function() {
    ...
    class CoffeeGenTask extends Task {
      async do() {
        ...
        return (await hooker.hookUpTheCoffee(this.moduleName));
      }
  ...
  StyleGenTask = (function() {
    ...
    class StyleGenTask extends Task {
      async do() {
        ...
        // log "\n - - - \nfileContent:\n" + fileContent
        await fs.writeFile(filePath, fileContent);
        return (await hooker.hookUpTheStyle(pugname));
      }
